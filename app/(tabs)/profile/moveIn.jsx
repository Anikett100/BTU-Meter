  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50">
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {/* Move-In Complete Status */}
        <View className="px-6 mt-6">
          <View className="bg-blue-50 border border-blue-200 rounded-2xl p-4 flex-row items-center">
        ...
        <View className="flex-row px-6 mt-6 gap-4">
          {/* Initial Reading */}
          <View className="flex-1 bg-white rounded-2xl p-4 shadow-sm border border-blue-200">
          ...
          <View className="flex-1 bg-white rounded-2xl p-4 shadow-sm border border-blue-200">
            ...
            <View className="flex-row items-center mt-1">
              <Image
                ...
                resizeMode="contain"
              />
              <Text className="text-xl font-bold text-gray-900">200.00</Text>
            </View>

            <Text className="text-blue-600 text-xs mt-1 font-medium">Paid</Text>
          </View>
        </View>

        {/* Service Details */}
        <View className="px-6 mt-8 mb-10">
          <View className="bg-white rounded-2xl p-5 shadow-sm border border-blue-200">
            <Text className="text-base font-semibold text-gray-900 mb-4">
              Service Details
            </Text>
  ...
  return (
    <View className="flex-row mb-5">
      <View className="items-center mr-4">
        ...
        <View className="w-[2px] flex-1 bg-blue-500 mt-1" />
      </View>
